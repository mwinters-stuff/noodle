...
func (suite *AppTemplateTableTestSuite) TestInsert() {
	...
	dbf.InsertMock(suite.script, "INSERT INTO application_template (appid,name,website,license,description,enhanced,tilebackground,icon,sha) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)",
...
func (suite *AppTemplateTableTestSuite) TestUpdate() {
	...
	dbf.InsertMock(suite.script, "UPDATE application_template SET name = $2,website = $3,license = $4,description = $5,enhanced = $6,tilebackground = $7,icon = $8,sha = $9 WHERE appid = $1",
		pgproto3.ParameterDescription{ParameterOIDs: []uint32{1042, 1043, 1043, 1043, 1043, 16, 1043, 1043, 1042}},
		pgproto3.Bind{
			DestinationPortal:    "",
			PreparedStatement:    "stmtcache_?",
...
func (suite *AppTemplateTableTestSuite) TestDelete() {
	...
	dbf.InsertMock(suite.script, "DELETE FROM application_template WHERE appid = $1",
