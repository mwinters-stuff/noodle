...
// UpdateDisplayOrder provides a mock function with given fields: tab
func (_m *ApplicationTabTable) UpdateDisplayOrder(tab models.ApplicationTab) error {
	ret := _m.Called(tab)
...
// ApplicationTabTable_UpdateDisplayOrder_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateDisplayOrder'
type ApplicationTabTable_UpdateDisplayOrder_Call struct {
	*mock.Call
}

// UpdateDisplayOrder is a helper method to define mock.On call
//   - tab models.ApplicationTab
func (_e *ApplicationTabTable_Expecter) UpdateDisplayOrder(tab interface{}) *ApplicationTabTable_UpdateDisplayOrder_Call {
	return &ApplicationTabTable_UpdateDisplayOrder_Call{Call: _e.mock.On("UpdateDisplayOrder", tab)}
}

func (_c *ApplicationTabTable_UpdateDisplayOrder_Call) Run(run func(tab models.ApplicationTab)) *ApplicationTabTable_UpdateDisplayOrder_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(models.ApplicationTab))
	})
	return _c
...
func (_c *ApplicationTabTable_UpdateDisplayOrder_Call) Return(_a0 error) *ApplicationTabTable_UpdateDisplayOrder_Call {
	_c.Call.Return(_a0)
	return _c
}

// UpdateTab provides a mock function with given fields: tab
func (_m *ApplicationTabTable) UpdateTab(tab models.ApplicationTab) error {
	ret := _m.Called(tab)
...
// ApplicationTabTable_UpdateTab_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateTab'
type ApplicationTabTable_UpdateTab_Call struct {
	*mock.Call
}

// UpdateTab is a helper method to define mock.On call
//   - tab models.ApplicationTab
func (_e *ApplicationTabTable_Expecter) UpdateTab(tab interface{}) *ApplicationTabTable_UpdateTab_Call {
	return &ApplicationTabTable_UpdateTab_Call{Call: _e.mock.On("UpdateTab", tab)}
}

func (_c *ApplicationTabTable_UpdateTab_Call) Run(run func(tab models.ApplicationTab)) *ApplicationTabTable_UpdateTab_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(models.ApplicationTab))
	})
	return _c
...
func (_c *ApplicationTabTable_UpdateTab_Call) Return(_a0 error) *ApplicationTabTable_UpdateTab_Call {
	_c.Call.Return(_a0)
	return _c
}
