...
func (suite *ApplicationTabHandlersTestSuite) TestHandlerApplicationTabsGet() {
	...
	params.TabID = 1
	response := handlers.HandlerApplicationTabGet(suite.mockDatabase, params, &pr)
...
func (suite *ApplicationTabHandlersTestSuite) TestHandlerApplicationTabsInsert() {
	...
	response := handlers.HandlerApplicationTabPost(suite.mockDatabase, params, &pr)
	require.NotNil(suite.T(), response)
...
func (suite *ApplicationTabHandlersTestSuite) TestHandlerApplicationTabsDelete() {
	...
	response := handlers.HandlerApplicationTabDelete(suite.mockDatabase, params, &pr)
	require.NotNil(suite.T(), response)
