...
export function ApplicationTemplateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApplicationTemplate {
    ...
    return {
        ...
        'TileBackground': !exists(json, 'tile_background') ? undefined : json['tile_background'],
        'Icon': !exists(json, 'Icon') ? undefined : json['Icon'],
        'SHA': !exists(json, 'SHA') ? undefined : json['SHA'],
    };
}

export function ApplicationTemplateToJSON(value?: ApplicationTemplate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
