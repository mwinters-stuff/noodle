...
func (o *DeleteNoodleUserApplicationsURL) Build() (*url.URL, error) {
	...
	var _path = "/noodle/user-applications"
	...
	userApplicationIDQ := swag.FormatInt64(o.UserApplicationID)
	if userApplicationIDQ != "" {
		qs.Set("user_application_id", userApplicationIDQ)
	}
...
func (o *DeleteNoodleUserApplicationsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteNoodleUserApplicationsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteNoodleUserApplicationsURL")
	}
