...
func NewGetNoodleGroupApplicationsParams() GetNoodleGroupApplicationsParams {
	...
	return GetNoodleGroupApplicationsParams{}
}

// GetNoodleGroupApplicationsParams contains all the bound params for the get noodle group applications operation
...
func (o *GetNoodleGroupApplicationsParams) bindGroupID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
		return errors.Required("group_id", "query", rawData)
	}
	var raw string
	if len(rawData) > 0 {
	...
	if err := validate.RequiredString("group_id", "query", raw); err != nil {
		return err
	}
