...
func NewDeleteNoodleApplicationsParams() DeleteNoodleApplicationsParams {
	...
	return DeleteNoodleApplicationsParams{}
}

// DeleteNoodleApplicationsParams contains all the bound params for the delete noodle applications operation
...
func (o *DeleteNoodleApplicationsParams) bindApplicationID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
		return errors.Required("application_id", "query", rawData)
	}
	var raw string
	if len(rawData) > 0 {
	...
	if err := validate.RequiredString("application_id", "query", raw); err != nil {
		return err
	}
