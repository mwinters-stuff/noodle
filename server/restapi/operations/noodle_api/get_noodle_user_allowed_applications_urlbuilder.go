...
func (o *GetNoodleUserAllowedApplicationsURL) Build() (*url.URL, error) {
	...
	var _path = "/noodle/user-allowed-applications"
...
func (o *GetNoodleUserAllowedApplicationsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetNoodleUserAllowedApplicationsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetNoodleUserAllowedApplicationsURL")
	}
