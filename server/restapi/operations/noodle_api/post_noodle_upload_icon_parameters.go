...
// PostNoodleUploadIconMaxParseMemory sets the maximum size in bytes for
...
func NewPostNoodleUploadIconParams() PostNoodleUploadIconParams {
	...
	return PostNoodleUploadIconParams{}
}

// PostNoodleUploadIconParams contains all the bound params for the post noodle upload icon operation
...
func (o *PostNoodleUploadIconParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if err := r.ParseMultipartForm(PostNoodleUploadIconMaxParseMemory); err != nil {
...
func (o *PostNoodleUploadIconParams) bindUpfile(file multipart.File, header *multipart.FileHeader) error {
	return nil
}
