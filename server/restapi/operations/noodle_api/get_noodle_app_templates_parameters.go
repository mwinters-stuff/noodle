...
func NewGetNoodleAppTemplatesParams() GetNoodleAppTemplatesParams {
	...
	return GetNoodleAppTemplatesParams{}
}

// GetNoodleAppTemplatesParams contains all the bound params for the get noodle app templates operation
...
func (o *GetNoodleAppTemplatesParams) bindSearch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
