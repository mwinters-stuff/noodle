...
func (o *DeleteNoodleGroupApplicationsURL) Build() (*url.URL, error) {
	...
	groupApplicationIDQ := swag.FormatInt64(o.GroupApplicationID)
	if groupApplicationIDQ != "" {
		qs.Set("group_application_id", groupApplicationIDQ)
	}
...
func (o *DeleteNoodleGroupApplicationsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteNoodleGroupApplicationsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteNoodleGroupApplicationsURL")
	}
