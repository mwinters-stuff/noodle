...
func NewGetNoodleUserApplicationsParams() GetNoodleUserApplicationsParams {
	...
	return GetNoodleUserApplicationsParams{}
}

// GetNoodleUserApplicationsParams contains all the bound params for the get noodle user applications operation
...
func (o *GetNoodleUserApplicationsParams) bindUserID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
