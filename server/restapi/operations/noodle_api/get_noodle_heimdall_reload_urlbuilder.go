...
func (o *GetNoodleHeimdallReloadURL) Build() (*url.URL, error) {
	...
	var _path = "/noodle/heimdall/reload"
...
func (o *GetNoodleHeimdallReloadURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetNoodleHeimdallReloadURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetNoodleHeimdallReloadURL")
	}
