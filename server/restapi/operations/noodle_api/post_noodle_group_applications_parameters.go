...
func NewPostNoodleGroupApplicationsParams() PostNoodleGroupApplicationsParams {
	...
	return PostNoodleGroupApplicationsParams{}
}

// PostNoodleGroupApplicationsParams contains all the bound params for the post noodle group applications operation
...
func (o *PostNoodleGroupApplicationsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.GroupApplications
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("groupApplication", "body", ""))
			} else {
				res = append(res, errors.NewParseError("groupApplication", "body", "", err))
			}
		} else {
