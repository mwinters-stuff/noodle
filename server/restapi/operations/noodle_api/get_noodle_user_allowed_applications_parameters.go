...
func NewGetNoodleUserAllowedApplicationsParams() GetNoodleUserAllowedApplicationsParams {
	...
	return GetNoodleUserAllowedApplicationsParams{}
}

// GetNoodleUserAllowedApplicationsParams contains all the bound params for the get noodle user allowed applications operation
...
func (o *GetNoodleUserAllowedApplicationsParams) bindUserID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
