...
func (o *PostAuthAuthenticateURL) WithBasePath(bp string) *PostAuthAuthenticateURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostAuthAuthenticateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostAuthAuthenticateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostAuthAuthenticateURL")
	}
