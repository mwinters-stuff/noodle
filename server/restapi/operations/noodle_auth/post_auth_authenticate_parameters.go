...
func NewPostAuthAuthenticateParams() PostAuthAuthenticateParams {
	...
	return PostAuthAuthenticateParams{}
}

// PostAuthAuthenticateParams contains all the bound params for the post auth authenticate operation
...
func (o *PostAuthAuthenticateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
