...
func NewGetAuthSessionParams() GetAuthSessionParams {
	...
	return GetAuthSessionParams{}
}

// GetAuthSessionParams contains all the bound params for the get auth session operation
...
func (o *GetAuthSessionParams) bindToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
